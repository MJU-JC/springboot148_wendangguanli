        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="专业" prop="yonghuTypes">
                        <el-select v-model="ruleForm.yonghuTypes" :disabled="ro.yonghuTypes" placeholder="请选择专业">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="专业" prop="yonghuValue">
